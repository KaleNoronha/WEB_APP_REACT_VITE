...
function Features() {
    ...
    return (
        <div className="w-full h-[700px] bg-[#0B1117] flex justify-center py-12 font-[Manrope] text-gray-300">
            <div className="w-4/5">
                <div className="text-center mb-10">
                    <h3 className="text-red-500 text-sm mb-2">WHY CHOOSE US</h3>
                    <h1 className="text-5xl">Customized Logistics Just for You</h1>
                </div>
                
                <div className="flex gap-10">
                    <aside className="w-1/4 space-y-12">
                    ...
                    <section 
                        className="w-1/2 mx-10 bg-cover bg-center"
                        style={{ backgroundImage: 'url(https://askproject.net/hauler/wp-content/uploads/sites/173/2024/02/banner-top-view-of-cargo-container-ship-carrying-c-C58MTNA.jpg)' }}
                    />
