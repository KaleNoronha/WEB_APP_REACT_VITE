        ...
        <div className="conteiner2">
            <div className="capa2">
                <div className="titulo">
                    <h3>WHY CHOOSE US</h3>
                    <h1>Customized Logistics Just for You</h1>
                </div>
                <div id="subcapa">
                    <aside id="subcapa-lateral">
                        <figure>
                            <img src={cajafuerte} alt="icono" />
                            <h1>Safe Packing</h1>
                            <figcaption>
                    ...
                    <section id="subcapa_centro" className="mx-10 px-10">
                    ...
                    <aside id="subcapa-lateral">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24">
                                <g fill="none" stroke="#dc2626" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
